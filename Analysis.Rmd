...
direct effect of body size on survival. Body size is a latent variable in the model. For model 
results in a figure see Fig. S13. The R-package used for the analysis is lavaan. 
